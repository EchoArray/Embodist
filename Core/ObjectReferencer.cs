...
public class ValueReference : System.Attribute
{
    /// <summary>
...
public class MethodReference : System.Attribute
{
    /// <summary>
    /// Identifies the name of the value
    /// </summary>
...
public static class ObjectReferencer
{
    ...
    public static System.Object GetValue(System.Object rootObject, string path)
    {
        if (rootObject == null)
            return null;
    ...
    private static System.Object FindGetValue(System.Object obj, string name, string storedKey)
    {
    ...
    public static void SetValue(System.Object rootObject, System.Object value, string path)
    {
        if (rootObject == null)
            return;
    ...
    private static void FindSetValue(object obj, object value, string name, string storedKey)
    {
        // Of the object has already been located and stored, return it
        if (_propertyInfos.ContainsKey(storedKey))
        {
    ...
    public static void InvokeMethod(System.Object rootObject, string path, object[] paramaters = null)
    {
        System.Object currentObject = rootObject;
